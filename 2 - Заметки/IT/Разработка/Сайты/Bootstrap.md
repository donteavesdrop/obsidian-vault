...
Создание утилит, начиная с Bootstrap 5, решается добавлением нового массива, который передаётся в обработчик, отдавая на выходе новые классы. А как создаётся новый компонент? В большинстве случаев достаточно внимательно пройтись по файлу __variables.scss_
...
![Приложение на Bootstrap](https://cdn6.hexlet.io/ZQA7m4CYxUdk.jpg)
